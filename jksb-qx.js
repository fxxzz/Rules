//Script of ZZU jksb
zzuid=$prefs.valueForKey('zzuid')
zzupw=$prefs.valueForKey('zzupw')
uid=$prefs.valueForKey('ptopidsid')
...
$task.fetch(url).then((resp) => cb(null, {}, resp.body) => {
        ...
        console.log(text+": \n")
        $prefs.setValueForKey(uid, 'ptopidsid')
    })
}
...
$task.fetch(url).then((resp) => cb(null, {}, resp.body) => {
    ...
    console.log(result)
    $notifypost(result,text+";"+textt+";"+result,"")
    })
}
